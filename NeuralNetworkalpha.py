...
alpha_vals = np.logspace(-6, 4, num=20)
...
ax.set_title('Neural Network Backprop Step Size', fontsize=18)
plt.show()
...
ax.set_xlabel('$\alpha$', fontsize=16)
ax.set_ylabel('$||Aw*-d||_2^2$', fontsize=16)
ax.set_title('eural Network Backprop Step Size', fontsize=18)
plt.xscale("log")
plt.show()
